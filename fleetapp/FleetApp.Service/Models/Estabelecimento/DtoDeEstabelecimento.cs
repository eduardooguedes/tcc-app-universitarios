...
public class DtoDeEstabelecimento
{
    ...
    [AtributoDeValidacaoCustomizadoCNPJ(ErrorMessage = "CNPJ inválido.")]
    ...
    /// <summary>
    /// Endereço de retirada do estabelecimento.
    /// </summary>
    [Required(ErrorMessage = "Obrigatório informar Endereço de Retirada.")]
    public DtoDeEnderecoRetirada EnderecoRetirada { get; set; }
}
